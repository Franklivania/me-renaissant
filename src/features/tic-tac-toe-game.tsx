  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <h3 className="lg:text-2xl font-im font-bold text-brown-100 sm:block">
          Tic-Tac-Toe
        </h3>
        <Button variant="ghost" onClick={resetGame} className="text-brown-100 hover:text-gold flex items-center">
